...
<p>Par ailleurs, l'émergence de l'informatique quantique et de la cryptographie quantique a renouvelé l'intérêt théorique pour les fondements, conduisant à des reformulations des axiomes sous une forme \\emph{complètement différente} de celle que l'on expose ci-dessous. Dans ces approches la structure de Hilbert n'est même pas postulée mais dérivée à partir d'une axiomatique informationnelle. Ces approches seront discutées en partie III ou IV [[[check later]]].</p>
      ...
      },
      {
        ...
        titleFr: "Leçon n°3",
        titleEn: "Lesson 3",
        subtitleFr: "Discussion des postulats",
        subtitleEn: "Discussion of the postulates",
        descriptionFr: "Discussion des postulats",
        descriptionEn: "Discussion of the postulates",
        topicsFr: [],
        topicsEn: [],
      ...
      },
      {
        ...
        titleFr: "Leçon n°4",
        titleEn: "Lesson 4",
        subtitleFr: "Position, impulsion et représentations d'une particule",
        subtitleEn: "Position, momentum, and particle representations",
        descriptionFr: "Position, impulsion et représentations d'une particule",
        descriptionEn: "Position, momentum, and particle representations",
        topicsFr: [],
        topicsEn: [],
      ...
      },
      {
        ...
        titleFr: "Leçon n°5",
        titleEn: "Lesson 5",
        subtitleFr: "Dynamique d'une particule",
        subtitleEn: "Dynamics of a particle",
        descriptionFr: "Dynamique d'une particule",
        descriptionEn: "Dynamics of a particle",
        topicsFr: [],
        topicsEn: [],
      ...
      {
        slug: "applications-lecon-5",
        number: 6,
        display_on_web: true,
        titleFr: "Leçon n°6",
        titleEn: "Lesson 6",
        subtitleFr: "Puits de potentiel et effet tunnel",
        subtitleEn: "Potential wells and tunneling",
        descriptionFr: "Puits de potentiel et effet tunnel",
        descriptionEn: "Potential wells and tunneling",
        topicsFr: [],
        topicsEn: [],
        texFile: "theme3_fr/lecon6.tex",
        references: [],
        content: "",
      },
      {
        slug: "applications-lecon-6",
        number: 7,
        display_on_web: true,
        titleFr: "Leçon n°7",
        titleEn: "Lesson 7",
        subtitleFr: "L'oscillateur harmonique",
        subtitleEn: "The harmonic oscillator",
        descriptionFr: "L'oscillateur harmonique",
        descriptionEn: "The harmonic oscillator",
        topicsFr: [],
        topicsEn: [],
        texFile: "theme3_fr/lecon7.tex",
        references: [],
        content: "",
      },
      {
        slug: "applications-lecon-7",
        number: 8,
        display_on_web: true,
        titleFr: "Leçon n°8",
        titleEn: "Lesson 8",
        subtitleFr: "L'atome d'hydrogène",
        subtitleEn: "The hydrogen atom",
        descriptionFr: "L'atome d'hydrogène",
        descriptionEn: "The hydrogen atom",
        topicsFr: [],
        topicsEn: [],
        texFile: "theme3_fr/lecon8.tex",
        references: [],
        content: "",
      },
      {
        slug: "applications-lecon-8",
        number: 9,
        display_on_web: true,
        titleFr: "Leçon n°9",
        titleEn: "Lesson 9",
        subtitleFr: "Le benzène : électrons délocalisés et spectre moléculaire",
        subtitleEn: "Benzene: delocalized electrons and molecular spectrum",
        descriptionFr: "Le benzène : électrons délocalisés et spectre moléculaire",
        descriptionEn: "Benzene: delocalized electrons and molecular spectrum",
        topicsFr: [],
        topicsEn: [],
        texFile: "theme3_fr/lecon9.tex",
        references: [],
        content: "",
      },
      {
        slug: "applications-lecon-9",
        number: 10,
        display_on_web: true,
        titleFr: "Leçon n°10",
        titleEn: "Lesson 10",
        subtitleFr: "Moment cinétique et spin",
        subtitleEn: "Angular momentum and spin",
        descriptionFr: "Moment cinétique et spin",
        descriptionEn: "Angular momentum and spin",
        topicsFr: [],
        topicsEn: [],
        texFile: "theme3_fr/lecon10.tex",
        references: [],
        content: "",
      },
      {
        slug: "applications-lecon-10",
        number: 11,
        display_on_web: true,
        titleFr: "Leçon n°11",
        titleEn: "Lesson 11",
        subtitleFr: "Oscillations, interférences et battements",
        subtitleEn: "Oscillations, interference, and beats",
        descriptionFr: "Oscillations, interférences et battements",
        descriptionEn: "Oscillations, interference, and beats",
        topicsFr: [],
        topicsEn: [],
        texFile: "theme3_fr/lecon11.tex",
        references: [],
        content: "",
      },
    ],
